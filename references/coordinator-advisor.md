...
This is the normative reference for hod `0.1.17` adaptive mode. It is
...
or evidence commands; those remain deferred beyond `0.1.17`.
...
11. `0.1.17` uses bounded Git, Herdr, and test commands; it adds no evidence
   validator command.
